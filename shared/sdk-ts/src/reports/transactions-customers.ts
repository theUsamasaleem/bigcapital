...
export async function fetchTransactionsByCustomersXlsx(
  ...
  ) as Promise<TransactionsByCustomersXlsxResponse>;
}
...
export async function fetchTransactionsByCustomersPdf(
  ...
  ) as Promise<TransactionsByCustomersPdfResponse>;
}
